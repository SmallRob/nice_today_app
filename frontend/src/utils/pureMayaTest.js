...
console.log(`KIN: ${targetResult.kin}`);
...
const todayResult = calculateMayaDate(today);
console.log(`\n=== 今日计算 ===`);
...
if (today === '2025-09-23') {
  ...
  console.log(`计算结果: ${todayResult.fullName}`);
  console.log(`验证: ${todayResult.fullName === '磁性的蓝夜' ? '✅ 正确！' : '❌ 错误！'}`);
}